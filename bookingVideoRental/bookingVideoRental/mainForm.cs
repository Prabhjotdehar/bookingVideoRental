    ...
    public partial class mainForm : Form
    {
        ...
        private void csInfo_Add_Click(object sender, EventArgs e)
        {
            if (csInfo_Name.Text.Equals("") && csInfo_email.Text.Equals("") && csInfo_Contact.Text.Equals("") && csInfo_City.Text.Equals(""))
            {
                ...
                try
                {
                    ...
                    string sql = "insert into Customer(Name,Email,Address,City) values (@name,@email,@address,@city)";
        ...
        private void csInfo_update_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    String connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=BookingVideo;Integrated Security=True";
                    string sql = "update Customer set Name=@name,Email=@email,Address=@address,City=@city where id=@id";
                    using (SqlConnection conn = new SqlConnection(connectionString))
                    {
                        conn.Open();
                        using (SqlCommand cmd = new SqlCommand(sql, conn))
        ...
        {
            if ( csInfo_Name.Text.Equals("") && csInfo_email.Text.Equals("") && csInfo_Add.Text.Equals("") && csInfo_City.Text.Equals(""))
            {
                MessageBox.Show("Must need to fill the details ");
            }
            else
                ...
                try
                {
                    ...
                    using (SqlConnection conn = new SqlConnection(connectionString))
                    {
                        ...
                        using (SqlCommand cmd = new SqlCommand(sql, conn))
                        {
                            ...
                            cmd.Parameters.AddWithValue("@ratting",viInfo_Plot.Text);
        ...
        private void viInfo_delete_Click(object sender, EventArgs e)
        {
            ...
            if (videorental_ID.Equals("") && csInfo_Name.Text.Equals("") && csInfo_email.Text.Equals("") && csInfo_Add.Text.Equals("") && csInfo_City.Text.Equals(""))
            {
                MessageBox.Show("Must need to fill the details ");
            }
            else
            {
                ...
                {
                    String connectionString = "Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=BookingVideo;Integrated Security=True";
                    string sql = "delete from Video  id=@id";
                    using (SqlConnection conn = new SqlConnection(connectionString))
                    {
                        conn.Open();
                        using (SqlCommand cmd = new SqlCommand(sql, conn))
        ...
        {
            if ( videorental_ID.Text.Equals("") && csInfo_Name.Text.Equals("") && csInfo_email.Text.Equals("") && csInfo_Add.Text.Equals("") && csInfo_City.Text.Equals(""))
            {
                MessageBox.Show("Must need to fill the details ");
            }
            else
        ...
        {
            DataTable tbl = new DataTable();
            SqlConnection conn = new SqlConnection("Data Source=(localdb)\\MSSQLLocalDB; Initial Catalog = BookingVideo; Integrated Security = True");
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (optn.Equals("customer")) {
               ...
               viInfo_points.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
                ...
                rentalInfo_csID.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
                videorental_ID.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
